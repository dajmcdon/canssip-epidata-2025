...
* At an earlier nowcast date $t_0,$ we define 
  ...
  + [**Finalized value**]{.primary} as the (potentially unobserved) finalized value of $Y_s_0.$
    - We only know in *hindsight* when reported value of $Y_s_0$ is finalized -- need an approximation. 
