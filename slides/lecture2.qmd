...
## Features -- summarize revision behaviour
...
#| echo: true
revision_data |> select(geo_value, time_value, lag_near_latest) |> slice_sample(n = 10)
```
...
revision_data |> select(geo_value, time_value, lag_near_latest) |> slice_sample(n = 5)
