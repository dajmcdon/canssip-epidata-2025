...
[**JHU CSSE COVID cases per 100k **]{.primary} estimates the daily number of new confirmed COVID-19 cases per 100,000 population, averaged over the past 7 days.
...
[**Change Healthcare COVID-like illness (CHNG-CLI)**]{.primary} reports the percentage of outpatient visits for COVID-related symptoms, based on deidentified Change Healthcare claims data.
...
[**Change Healthcare COVID (CHNG-COVID)**]{.primary} reports the percentage of outpatient visits with confirmed COVID-19, based on Change Healthcare claims data.
...
[**Confirmed COVID-19 Hospital Admissions per 100k**]{.primary} estimates the daily sum of adult and pediatric confirmed COVID-19 hospital admissions, per 100,000 population, averaged over the past 7 days.
