...
* Geo-pooled predictions tend to be [more stable]{.primary} with [wider intervals]{.primary}

* Meanwhile, predictions from state-wise models tend to be [more volatile]{.primary}

The extent to which this occurs differs based on the horizon. Previously we studied $h=28$. What happens for $h=7$?
